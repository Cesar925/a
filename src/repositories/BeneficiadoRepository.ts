...
export class BeneficiadoRepository {
  ...
  // Obtener todos los registros BENEFICIADO (Arequipa + Provincia)
  async findAll(filters: QueryFilters): Promise<Registro[]> {
    let query = `
      ...
      WHERE p.nombre IN ('Arequipa Beneficiado', 'Provincia Beneficiado')
    `
  ...
  // Obtener registros de Arequipa Beneficiado
  ...
  // Obtener registros de Provincia Beneficiado
  ...
  // Métodos CRUD (idénticos a VivoRepository)
